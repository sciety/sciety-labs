...
class TestGetSiteConfigFromEnvironmentVariables:
    def test_should_return_none_values_if_not_configured(self):
        ...
        assert site_config.preferred_host is None
    ...
    def test_should_return_preferred_host_from_env_var(self, env_mock: dict):
        env_mock[SiteConfigEnvironmentVariables.PREFERRED_HOST] = 'host_1'
        site_config = get_site_config_from_environment_variables()
        assert site_config.preferred_host == 'host_1'
